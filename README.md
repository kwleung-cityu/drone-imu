...
Current build signature: `V3-MIN-SIG-20260703-H`
Current build signature code: `41022`
...
"dependencies": {
    "core": "*",
    "drone-imu-v3-min": "github:kwleung-cityu/drone-imu#v1.0.22"
}
```
...
```python
serial.write_value("probe", droneIMUV3.releaseProbe122())
serial.write_value("sig", droneIMUV3.buildSignatureCode())
```

Expected for `v1.0.22`:
